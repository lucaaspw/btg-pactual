...
export function UltrablueWhy() {
  return (
    <section
      id="beneficios"
      className="scroll-mt-24 bg-[#F1F4F8] py-12 md:px-5 sm:py-16 lg:px-8"
    >
      <div className="mx-auto grid max-w-[1280px] items-center gap-8 lg:grid-cols-2 lg:gap-10">
        ...
        <div className="px-5 text-center lg:text-left">
          <h2 className="text-2xl font-bold leading-tight text-[#0B2859] md:text-3xl">
            Por que ter o Ultrablue com você
          </h2>

          <ul className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:mt-10 lg:gap-x-8 lg:gap-y-10">
            {features.map(({ imageSrc, title, text }) => (
              <li key={title} className="w-full">
                <div className="flex items-start gap-3 text-left">
                  ...
                  />
                  <div>
                    <h3 className="text-sm font-bold text-[#10408D] md:text-base">
                      {title}
                    </h3>
                    <p className="mt-1 text-xs leading-relaxed text-[#05132A] md:text-sm">
                      {text}
                    </p>
                  </div>
                </div>
