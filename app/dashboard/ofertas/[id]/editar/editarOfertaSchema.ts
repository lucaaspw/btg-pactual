  ...
  imagem: z
    ...
    .superRefine((file, ctx) => {
      ...
      if (!ALLOWED_IMAGE_TYPES.has(file.type || "")) {
        ctx.addIssue({
          code: "custom",
          message: "Formato não aceito. Use apenas JPG, JPEG ou PNG.",
        });
      }
    }),
...
export type EditarOfertaFormInput = z.input<typeof editarOfertaSchema>;
export type EditarOfertaFormValues = z.output<typeof editarOfertaSchema>;
