...
export default function NovaOferta() {
  ...
  const inputClass =
    "w-full rounded-lg border border-gray-200 bg-[#f8fafc] px-3 py-2 text-sm text-gray-900 outline-none transition focus:border-[#2E73D4] focus:ring-2 focus:ring-[#2E73D4]/20";
                ...
                <div className="space-y-3">
                  <div>
                    <label className={labelClass} htmlFor="tipo_cartao">
                      Tipo de cartão{" "}
                      <span className="bg-red-100 text-red-700 rounded-sm text-[10px] p-1">
                        Obrigatório
                      </span>
                    </label>
                    <select
