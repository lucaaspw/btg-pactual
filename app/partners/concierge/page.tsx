      ...
      <main className="bg-btg-navy text-white">
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 md:px-5 sm:gap-5 md:grid-cols-2 xl:grid-cols-4">
              {travelExamples.map((item) => (
                <article key={item.label} className="overflow-hidden">
                  ...
                  <p className="p-4 text-center text-[1.3rem] md:text-xl">
                    {item.label}
                  </p>
                </article>
              ))}
        ...
        <section className="px-5 md:py-14 py-5 lg:px-8">
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="md:mt-8 grid grid-cols-2 items-center justify-center gap-x-4 gap-y-4 sm:gap-x-6 sm:gap-y-5 sm:pt-8 md:grid-cols-4 lg:grid-cols-8">
